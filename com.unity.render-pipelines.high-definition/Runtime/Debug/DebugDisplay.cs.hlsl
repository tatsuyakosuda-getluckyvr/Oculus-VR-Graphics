...
#define FULLSCREENDEBUGMODE_WATER (17)
#define FULLSCREENDEBUGMODE_MAX_LIGHTING_FULL_SCREEN_DEBUG (18)
#define FULLSCREENDEBUGMODE_MIN_RENDERING_FULL_SCREEN_DEBUG (19)
#define FULLSCREENDEBUGMODE_MOTION_VECTORS (20)
#define FULLSCREENDEBUGMODE_NAN_TRACKER (21)
#define FULLSCREENDEBUGMODE_COLOR_LOG (22)
#define FULLSCREENDEBUGMODE_DEPTH_OF_FIELD_COC (23)
#define FULLSCREENDEBUGMODE_TRANSPARENCY_OVERDRAW (24)
#define FULLSCREENDEBUGMODE_QUAD_OVERDRAW (25)
#define FULLSCREENDEBUGMODE_VERTEX_DENSITY (26)
#define FULLSCREENDEBUGMODE_REQUESTED_VIRTUAL_TEXTURE_TILES (27)
#define FULLSCREENDEBUGMODE_LENS_FLARE_DATA_DRIVEN (28)
#define FULLSCREENDEBUGMODE_MAX_RENDERING_FULL_SCREEN_DEBUG (29)
#define FULLSCREENDEBUGMODE_MIN_MATERIAL_FULL_SCREEN_DEBUG (30)
#define FULLSCREENDEBUGMODE_VALIDATE_DIFFUSE_COLOR (31)
#define FULLSCREENDEBUGMODE_VALIDATE_SPECULAR_COLOR (32)
#define FULLSCREENDEBUGMODE_MAX_MATERIAL_FULL_SCREEN_DEBUG (33)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_PREV (34)
#define FULLSCREENDEBUGMODE_SCREEN_SPACE_REFLECTIONS_ACCUM (35)
#define FULLSCREENDEBUGMODE_WORLD_SPACE_POSITION (36)
