...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public partial class HDRenderPipeline
    {
        ...
        void PushLightDataGlobalParams(CommandBuffer cmd)
        {
            ...
            m_TileAndClusterData.convexBoundsBuffer.SetData(m_GpuLightsBuilder.lightBounds, 0, 0, m_GpuLightsBuilder.allLightBoundsCount);
            m_TileAndClusterData.lightVolumeDataBuffer.SetData(m_GpuLightsBuilder.lightVolumes, 0, 0, m_GpuLightsBuilder.allLightBoundsCount);
