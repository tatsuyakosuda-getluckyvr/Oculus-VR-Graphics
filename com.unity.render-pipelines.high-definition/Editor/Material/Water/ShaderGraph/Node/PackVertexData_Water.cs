...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    [Title("Utility", "High Definition Render Pipeline", "Ocean", "PackVertexData_Water (Preview)")]
    class PackVertexData_Water : AbstractMaterialNode, IGeneratesBodyCode
    {
        ...
        const int kFaomFromHeightInputSlotId = 4;
        const string kFaomFromHeightInputSlotName = "FaomFromHeight";
        ...
        public sealed override void UpdateNodeAfterDeserialization()
        {
            ...
            AddSlot(new Vector1MaterialSlot(kFaomFromHeightInputSlotId, kFaomFromHeightInputSlotName, kFaomFromHeightInputSlotName, SlotType.Input, 0, ShaderStageCapability.Vertex));
        ...
        public void GenerateNodeCode(ShaderStringBuilder sb, GenerationMode generationMode)
        {
            if (generationMode == GenerationMode.ForReals)
            {
                ...
                string foamFromHeight = GetSlotValue(kFaomFromHeightInputSlotId, generationMode);
